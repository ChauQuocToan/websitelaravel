            ...
            <div class="col-12">
                <div class="bread-inner">
                    <ul class="bread-list">
                        ...
                        <li class="active"><a href="">Chi Tiết Của Hàng</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-12">
                        <div class="product-des">
                            ...
                            <!-- Color -->
                            <div class="color">
                                <h4>Tùy Chọn Có Sẵn <span>Các Loại Màu</span></h4>
                                <ul>
                            ...
                            <div class="product-buy">
                                ...
                                <p class="cat">Sản Phẩm : <a href="">{{$product_detail->cat_info['title']}}</a></p>
                                @if($product_detail->sub_cat_info)
                                <p class="cat mt-1">Dịch Sản Phẩm :<a href="">{{$product_detail->sub_cat_info['title']}}</a></p>
                                @endif
